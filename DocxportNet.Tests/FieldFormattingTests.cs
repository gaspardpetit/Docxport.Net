...
public class FieldFormattingTests
{
    ...
    public void Formatter_AlphabeticAndRomanTransforms()
    {
        ...
        var alpha = formatter.Format(
            ...
            [new DxpTextTransformFormatSpec(DxpTextTransformKind.Alphabetic, "\\* ALPHABETIC", "ALPHABETIC")],
            context);
        var roman = formatter.Format(
            new DxpFieldValue(9),
            [new DxpTextTransformFormatSpec(DxpTextTransformKind.Roman, "\\* roman", "roman")],
            context);
    ...
    public void Formatter_OrdinalAndCardText()
    {
        ...
        var ordinal = formatter.Format(
            ...
            [new DxpTextTransformFormatSpec(DxpTextTransformKind.Ordinal, "\\* Ordinal", "Ordinal")],
            context);
        var card = formatter.Format(
            new DxpFieldValue(42),
            [new DxpTextTransformFormatSpec(DxpTextTransformKind.CardText, "\\* CardText", "CardText")],
            context);
    ...
    public void Formatter_NumericPictureFormats()
    {
        ...
        var r1 = formatter.Format(new DxpFieldValue(9), [spec1], context);
        var r2 = formatter.Format(new DxpFieldValue(222492), [spec2], context);
        var r3 = formatter.Format(new DxpFieldValue(15), [spec3], context);
    ...
    public void Formatter_NumericSectionsAndSigns()
    {
        ...
        var pos = formatter.Format(new DxpFieldValue(1234.5), [spec], context);
        var neg = formatter.Format(new DxpFieldValue(-1234.5), [spec], context);
        var zero = formatter.Format(new DxpFieldValue(0), [spec], context);
    ...
    public void Formatter_NumericGroupingPreservesExtraDigits()
    {
        ...
        var result = formatter.Format(new DxpFieldValue(1234567), [spec], context);
    ...
    public void Formatter_NumericFormat_NoPlaceholdersOmitsDigits()
    {
        ...
        var result = formatter.Format(new DxpFieldValue(123), [spec], context);
    ...
    public void Formatter_NumericFormat_RightAlignsDigits()
    {
        ...
        var r1 = formatter.Format(new DxpFieldValue(12), [specZero], context);
        var r2 = formatter.Format(new DxpFieldValue(12), [specOptional], context);
    ...
    public void Formatter_NumericOptionalDigitsAndPlusSign()
    {
        ...
        var spec = (DxpNumericFormatSpec)new DxpFieldParser().Parse("X \\# \"+#; -#; 0\"").Ast.FormatSpecs[0];
        var pos = formatter.Format(new DxpFieldValue(7), [spec], context);
        var neg = formatter.Format(new DxpFieldValue(-7), [spec], context);
        var zero = formatter.Format(new DxpFieldValue(0), [spec], context);
    ...
    public void Formatter_NumericPercentAndLiterals()
    {
        ...
        var result = formatter.Format(new DxpFieldValue(12.3), [spec], context);
    ...
    public void Formatter_NumericTrimsOptionalFraction()
    {
        ...
        var spec = (DxpNumericFormatSpec)new DxpFieldParser().Parse("X \\# \"0.##\"").Ast.FormatSpecs[0];
        var r1 = formatter.Format(new DxpFieldValue(1.2), [spec], context);
        var r2 = formatter.Format(new DxpFieldValue(1.0), [spec], context);
    ...
    public void Formatter_DateTimeTokensAndLiterals()
    {
        ...
        var text = formatter.Format(value, [spec], context);
    ...
    public void Formatter_RespectsCultureForCasing()
    {
        ...
        var firstCap = formatter.Format(
            value,
            [new DxpTextTransformFormatSpec(DxpTextTransformKind.FirstCap, "\\* FirstCap", "FirstCap")],
            context);
    ...
    public void Formatter_AmPmPeriodsCanBePreservedOrStripped()
    {
        ...
        var keep = formatter.Format(value, [spec], contextKeep);
        var strip = formatter.Format(value, [spec], contextStrip);
    ...
    {
        var formatter = new DxpFieldFormatter();
        DxpFieldEvalContext context = new() { Culture = new CultureInfo("en-US") };
        context.SetNumberedItem("table", "2");

        var numericSpec = (DxpNumericFormatSpec)new DxpFieldParser().Parse("X \\# \"0 `table`\"").Ast.FormatSpecs[0];
        var numericText = formatter.Format(new DxpFieldValue(5), [numericSpec], context);
    ...
    public void Formatter_NumericParsingHonorsInvariantFallbackFlag()
    {
        ...
        var strict = formatter.Format(value, [spec], contextStrict);
        var loose = formatter.Format(value, [spec], contextLoose);
    ...
    public void Formatter_TextTransforms_DollarAndOrdTextAndArabicDash()
    {
        ...
        var dollar = formatter.Format(
            ...
            [new DxpTextTransformFormatSpec(DxpTextTransformKind.DollarText, "\\* DollarText", "DollarText")],
            context);
        var ordText = formatter.Format(
            new DxpFieldValue(21),
            [new DxpTextTransformFormatSpec(DxpTextTransformKind.OrdText, "\\* OrdText", "OrdText")],
            context);
        var arabicDash = formatter.Format(
            new DxpFieldValue(31),
            [new DxpTextTransformFormatSpec(DxpTextTransformKind.ArabicDash, "\\* ArabicDash", "ArabicDash")],
            context);
