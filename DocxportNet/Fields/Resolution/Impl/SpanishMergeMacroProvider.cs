...
public sealed class SpanishMergeMacroProvider : SimpleMergeMacroProvider
{
    protected override string LanguageCode => "es";
    protected override string Salutation => "Estimado";
    protected override string? DualFormSalutation => "Estimado/a";
    ...
    protected override string DefaultGreeting => "Hola,";
