...
public sealed class FinnishMergeMacroProvider : SimpleMergeMacroProvider
{
    protected override string LanguageCode => "fi";
    protected override string Salutation => "Hyvä";
    protected override string DefaultGreeting => "Hei,";
