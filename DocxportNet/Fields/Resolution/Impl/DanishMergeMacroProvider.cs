...
public sealed class DanishMergeMacroProvider : SimpleMergeMacroProvider
{
    protected override string LanguageCode => "da";
    protected override string Salutation => "Kære";
    protected override string DefaultGreeting => "Hej,";
