...
public sealed class GreekMergeMacroProvider : SimpleMergeMacroProvider
{
    protected override string LanguageCode => "el";
    protected override string Salutation => "Αγαπητέ";
    protected override string? DualFormSalutation => "Αγαπητέ/ή";
    ...
    protected override string DefaultGreeting => "Γεια σας,";
